...
hero:
  ...
  tagline: The comprehensive API documentation guide for LLM Spark. Your go-to guide for seamless Integration.
---


import { Tabs, TabItem } from '@astrojs/starlight/components';

<div className='text-4xl font-extrabold border border-b-1 border-t-0 border-x-0 pb-6 dark:text-white mb-12 !leading-[50px]'>  API Documentation | LLM Spark </div>
