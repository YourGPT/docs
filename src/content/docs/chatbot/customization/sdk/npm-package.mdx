---
title: "NPM Package | YourGPT Chatbot SDK"
description: "Install and use the YourGPT Web SDK via NPM"
keywords: npm package, web sdk, yourgpt sdk, chatbot integration, react hooks, ai actions
hero:
  title: "NPM Package | YourGPT Chatbot SDK"
  tagline: "Complete guide to install and integrate the YourGPT Web SDK"
---

<div className='text-4xl font-extrabold border border-b-1 border-t-0 border-x-0 pb-6 dark:text-white mb-12 !leading-[50px]'>NPM Package | YourGPT Chatbot SDK</div>
...
<Aside type="note">
**What is the YourGPT Web SDK?** It's a JavaScript library that provides programmatic control over your YourGPT chatbot widget. Instead of just embedding the widget with a script tag, the SDK gives you full control over when it opens, closes, sends messages, and handles AI actions.
</Aside>

## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>Quick Start</div>

### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>Vanilla JavaScript/TypeScript</div>
...
<Aside type="tip">
**Widget ID**: This is a unique identifier for your chatbot. You can find it in your YourGPT dashboard in the Integrations section. It looks something like "abc123def456" [YourGPT Dashboard](https://app.yourgpt.ai).
</Aside>

### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>React Set Up</div>

```javascript
import { YourGPT, useYourGPTChatbot, useAIActions } from "@yourgpt/widget-web-sdk";
...
<Aside type="note">
**AI Actions**: These are custom functions that your chatbot can trigger. For example, when a user asks "What's my location?", the chatbot can call your custom `get_location` action to get the user's actual location and respond with it.
</Aside>

## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>Complete Documentation</div>

### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>AI Actions System</div>
...
<Aside type="note">
**helpers.confirm()**: This shows a user-friendly confirmation dialog. The user can click "Accept" or "Reject", and your code waits for their decision before continuing.
</Aside>

## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>Hooks</div>

React hooks provide an easy way to use the SDK in React components.

### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>useYourGPTChatbot() - Main Widget Control</div>

This hook gives you control over the chatbot widget and access to its current state.

```javascript
import { useYourGPTChatbot } from "@yourgpt/widget-web-sdk";
...
### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>useAIActions() - AI Actions Management</div>

This hook helps you register and manage custom AI actions in React components.

```javascript
import { useAIActions } from "@yourgpt/widget-web-sdk";
...
## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>Components</div>

### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>YourGPTProvider - Wrapper</div>
...
### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>Custom Confirmation Dialogs</div>
...
## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>Project Structure</div>
...
## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>Testing</div>
...
## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>Development</div>

### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>Setup</div>
...
### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>Available Scripts</div>
...
## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>Build Output</div>
...
## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>API Reference</div>

### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>Core SDK Classes</div>

- `YourGPTSDK` - Main SDK class
- `YourGPT` - Static methods for easy access
- `YourGPTError` - Custom error handling

### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>React Hooks</div>
...
### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>Types</div>
...
### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>Utilities</div>
...
## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>Browser Support</div>
...
## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>Framework Compatibility</div>
...
## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>Migration Guide</div>

### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>From Script-based Integration</div>
...
### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'>From React Class Components to Hooks</div>
...
## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>FAQ</div>
...
## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'>Resources</div>
