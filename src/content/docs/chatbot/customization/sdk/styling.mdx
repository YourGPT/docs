...
<Image
  ...
  width={300}
  height={300}
  className="nx-mt-2 nx-rounded-lg nx-overflow-hidden"
/>
...
<Image src="/assets/chatbot/chatbot-widget-btn-animation-2.gif" alt="Hello" width={300} height={300} className='nx-mt-2 nx-rounded-lg nx-overflow-hidden' />
...
opacity: 0;
  ...
  <TabItem label="Ripple" >
    ...
    <Image src="/assets/chatbot/chatbot-widget-btn-animation-3.gif" alt="Hello" width={300} height={300} className='nx-mt-2 nx-rounded-lg nx-overflow-hidden' />
