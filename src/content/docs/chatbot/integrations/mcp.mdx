...
description: Learn how to integrate YourGPT Chatbot with Claude Desktop, Cursor, and Windsurf using the Model Context Protocol (MCP).
keywords: mcp integration chatbot, ai bot mcp, custom bot mcp, mcp gpt Chatbot, model context protocol
hero:
  title: MCP Integration Guide (Model Context Protocol)
