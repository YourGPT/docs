---
title: API Integration | YourGPT APIs Guide   
...
<div className="text-4xl font-extrabold border border-b-1 border-t-0 border-x-0 pb-6 dark:text-white mb-12 !leading-[50px]"> API Integration </div>
