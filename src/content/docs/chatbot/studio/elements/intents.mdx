...
<Note type="note" color="blue">
  In the restrictions setting '**only answer from knowledge base**' will prevent function calls, which may result in the intent not being detected. 
  
  Make sure to change the restrictions to "... **answer from knowledge base & function calling**"
</Note>
