...
Learn more about on our [Help center article on Capture](https://help.yourgpt.ai/article/how-to-capture-and-store-a-users-response-32).
...
Learn more about on our [Help center article on Button](https://help.yourgpt.ai/article/how-to-create-configure-buttons-in-studio-828).

---

## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'> Form Listener</div>
