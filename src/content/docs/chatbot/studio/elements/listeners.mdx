...
## <div className='text-3xl tracking-tight font-bold dark:text-inherit text-gray-700'> 4. Feedback </div>
<div className="flex justify-center items-center bg-blue-500 rounded-md p-2">
  <Image 
    src="/assets/flow/listener/feedback.png" 
    alt="Feedback Listeners in YourGPT Studio"
    width="100%"
    height="100%"
    style={{ width: "100%" }}
    className="rounded-md" 
...
### <div className='text-2xl tracking-tight font-semibold dark:text-inherit text-gray-700'> Features of Feedback Listener </div>
