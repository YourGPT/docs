...
hero:
  title: API Calling in YourGPT Chatbot Studio
  tagline: Learn how to use API Calls in your chatbot to interact with external services, fetch real-time data, or trigger actions during conversations.
---

import { Steps } from '@astrojs/starlight/components';

<div className="text-4xl font-extrabold border border-b-1 border-t-0 border-x-0 pb-6 dark:text-white mb-12 !leading-[50px]"> API Calling in YourGPT Chatbot Studio </div>
