...
export const sidebarNavigation = [
  ...
  { href: "/chatbot/customization/sdk/yourgpt-method", label: "$yourgpt Method" },
  { href: "/chatbot/customization/sdk/npm-package", label: "NPM Package" },
  { href: "/chatbot/customization/sdk/ai-copilot", label: "AI Copilot" },
  { href: "/chatbot/customization/sdk/styling", label: "Styling" },
  { href: "/chatbot/customization/sdk/gamification", label: "Support Gamification" },
  { href: "/chatbot/customization/sdk/sales-gamification", label: "Sales Gamification" },
  { href: "/chatbot/customization/sdk/identity-verification", label: "Identity Verification" },
  { href: "/chatbot/customization/sdk/react-native-chatbot-sdk", label: "React Native Chatbot SDK" },
  { href: "/chatbot/customization/sdk/ios-chatbot-sdk", label: "iOS Chatbot SDK" },
  { href: "/chatbot/customization/sdk/flutter-chatbot-sdk", label: "Flutter Chatbot SDK" },
  { href: "/chatbot/customization/sdk/android-chatbot-sdk", label: "Android Chatbot SDK" },
 ...
 */
export function getPaginationPages(currentUrl: string): { prev: NavLink | null; next: NavLink | null; currentIndex: number } {
