  ...
  - To set up a Permanent Access Token:
    ...
    8. Copy and save your Permanent Access Token.
        <div className="flex justify-center items-center rounded-md p-4 md:px-12">
          ![WhatsApp Integration Settings](/assets/chatbot/whatsapp.png)
        </div>
...
<div className="flex justify-center items-center rounded-md p-4 md:px-12">
  ![Troubleshooting](/assets/chatbot/whatsapp/troubleshoot.png)
</div>
...
> **WARNING:** Forms are not supported on Whatsapp
