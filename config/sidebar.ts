...
export default defineConfig({
  integrations: [
    starlight({
      title: 'Documentation',
      description: 'Comprehensive documentation for our products',
      ...
      sidebar: (route) => {
        ...
        } else if (route.startsWith('/llm-spark')) {
          return [
            {
              label: 'LLM Spark',
              items: [
                {
                  ...
                  items: [
                    ...
                    { label: 'Multi LLM Support', link: '/llm-spark/multi-llm-support' },
                    { label: 'External Data Connection', link: '/llm-spark/external-data-connection' },
                    { label: 'Team Collaboration', link: '/llm-spark/team-collaboration' },
                    { label: 'Version Control', link: '/llm-spark/version-control' },
                    { label: 'Observability Tools', link: '/llm-spark/observability-tools' },
                    { label: 'Template Directory', link: '/llm-spark/template-directory' },
                  ],
                },
                {
                ...
                {
                  label: 'Deployment',
                  link: '/llm-spark/deployment',
                },
                {
                  label: 'Monitoring & Analytics',
                  link: '/llm-spark/monitoring-analytics',
                },
              ],
            },
          ];
